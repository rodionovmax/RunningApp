package com.rodionovmax.runningapp.di
...
import com.rodionovmax.runningapp.other.Constants.RUNNING_DATABASE_NAME
import com.rodionovmax.runningapp.other.Constants.SHARED_PREFERENCES_NAME
...
object AppModule {
    ...
    @Singleton
    @Provides
    fun provideWeight(sharedPref: SharedPreferences) = sharedPref.getFloat(KEY_WEIGHT, 80f) ?: 80f
